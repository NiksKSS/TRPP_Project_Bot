# ILOVEIMAGE❤️ Bot
![alt text](telegram-peer-photo-size-2-5312171322026693649-1-0-0.jpg)
...
│   │   ├── photo_to_text.py    # OCR функционал
│   │   ├── text_to_photo.py   # Генерация изображений
│   │   ├── ask_from_image.py   # VQA функционал
│   │   └── states.py       # FSM состояния для управления диалогом
│   └── core/
